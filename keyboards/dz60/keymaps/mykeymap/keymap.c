...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_JP] = LAYOUT_directional(  \
       KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,S(KC_MINS), KC_BSPC , S(KC_LBRC), \
      ...
      MO(_JP_SHIFT),    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, _______, KC_SLSH,   MO(_JP_SHIFT), LT(_FN,KC_GRV),
      MO(_FN), KC_LGUI, KC_LALT,           KC_SPC,           KC_SPC,           KC_SPC,          KC_RALT, _______, KC_LEFT, S(KC_LBRC), S(KC_LBRC)      \
      ), 
  ...
  [_JP_SHIFT] = LAYOUT_directional(  \
      ...
      _______, S(KC_Z), S(KC_X), S(KC_C), S(KC_V), S(KC_B), S(KC_N), S(KC_M),S(KC_COMM),S(KC_DOT), _______,S(KC_SLSH),_______ ,KC_INT5,         \
  ...
  [_FN] = LAYOUT_directional(
      ...
      KC_LSFT         , KC_BTN1, KC_BTN3, KC_BTN2, _______,TO(_ADJ), _______, _______, _______, _______, _______, KC_DOWN, KC_MS_U, _______,     \
