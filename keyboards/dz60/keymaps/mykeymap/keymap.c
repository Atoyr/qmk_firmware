...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_US] = LAYOUT_directional(  \
      ...
      KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_SLSH, KC_RSFT, MO(_FN),             \
      MO(_FN) , KC_LGUI, KC_LALT,           KC_SPC,           KC_SPC,           KC_SPC,          KC_RALT,  KC_APP,  KC_APP, KC_RGUI, MY_USZH     \
      ),
